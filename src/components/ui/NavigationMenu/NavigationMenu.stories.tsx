            ...
            <ul className="tw:grid tw:gap-3 tw:p-4 tw:md:w-[400px] tw:lg:w-[500px] tw:lg:grid-cols-[.75fr_1fr]">
              <li className="tw:row-span-3">
                <NavigationMenuLink asChild>
                  <a
                    className="tw:flex tw:h-full tw:w-full tw:select-none tw:flex-col tw:justify-end tw:rounded-md tw:bg-linear-to-b tw:from-muted/50 tw:to-muted tw:p-6 tw:no-underline tw:outline-hidden tw:focus:shadow-md"
                    href="/"
                  >
