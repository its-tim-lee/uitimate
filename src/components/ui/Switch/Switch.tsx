  ...
  return (
    <SwitchPrimitive.Root
      className={cn(
        ...
        "tw:focus-visible:ring-4 tw:focus-visible:outline-hidden tw:focus-visible:outline-1 tw:disabled:cursor-not-allowed tw:disabled:opacity-50 tw:aria-invalid:focus-visible:ring-0",
