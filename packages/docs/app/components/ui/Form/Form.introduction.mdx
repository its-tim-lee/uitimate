...
<details>
<TrackableSummary id="why-is-building-forms-hard">**DEEP DIVE**: Why is building forms hard?</TrackableSummary>
...
<details>
<TrackableSummary id="what-is-rhf">**DEEP DIVE**: What's RHF?</TrackableSummary>
...
<DirtyFixCodeBlock id="form-anatomy" />
...
<QA2>
  <QA2Item >
    <QA2Trigger id='uitimate-form-vs-shadcn-form'>**@uitimate/form** vs. **<u>Shadcn</u>**'s form?</QA2Trigger>
     <QA2Content>
        I believe I've encapsulated RHF so well that it'll 100% boost your DX when building forms, period.
     </QA2Content>
   </QA2Item>
  <QA2Item >
    <QA2Trigger id='why-encapsulate-rhf'>Why encapsulate RHF?</QA2Trigger>
     <QA2Content>
