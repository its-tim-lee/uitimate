...
<QA2>
  ...
  <QA2Item >
    <QA2Trigger>Why even encapsulated RHF?</QA2Trigger>
     <QA2Content>
        Without a really good encapsulation, there can have many bollierplates during your usage of RHF,
        and it sucks!
     </QA2Content>
   </QA2Item>
