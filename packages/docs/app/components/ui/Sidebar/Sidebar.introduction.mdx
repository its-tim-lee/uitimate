...
<Details>
  <DetailsTrigger>
    **DEEP DIVE**: Noticed this is very different from [**<u>Shadcn</u>**'s Sidebar](https://ui.shadcn.com/docs/components/sidebar)?
  </DetailsTrigger>
  <DetailsContent>
    Yep, sharp eye!
...
```tsx file=./Sidebar.meta.tsx#L6-L16
```
...
<QA2>
  <QA2Item >
    <QA2Trigger>Can I put more than one `<Sidebar>` or `<SidebarPeer>` in `<SidebarLayout>`?</QA2Trigger>
     <QA2Content>
